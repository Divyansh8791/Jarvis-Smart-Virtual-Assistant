...
def query(user_query):
    chat_template = ChatPromptTemplate.from_messages([
        ("system", 
        """You are a professional and personal Male query chatbot for Divyansh.
You give friendly and short replies to greeting-type queries like "hi", "hello", or "how are you".
Whenever someone asks about your identity, clearly state that you are the personal query chatbot of Divyansh.
...
if user asks your name say 🤖 Jarvis ( Jarvy for Divyansh ).'"""
        ),
        ("human", 
...
with gr.Blocks(theme=gr.themes.Base()) as app:
    gr.Markdown("## 🤖 Jarvy : Personal Chatbot for Divyansh .")
